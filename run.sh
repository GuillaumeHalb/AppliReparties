...
gnome-terminal --execute java -jar Server/target/*.jar Deutsche_Bank 8 start
 #adding neighboor
gnome-terminal --execute java -jar Server/target/*.jar Goldman_Sachs JP_Morgan,Merill_Lynch,HSBC add
gnome-terminal --execute java -jar Server/target/*.jar  JP_Morgan Goldman_Sachs,Citi add
gnome-terminal --execute java -jar Server/target/*.jar Citi Merill_Lynch,Barclays,BNP,JP_Morgan add
gnome-terminal --execute java -jar Server/target/*.jar Merill_Lynch Goldman_Sachs,Citi,HSBC add
gnome-terminal --execute java -jar Server/target/*.jar HSBC Merill_Lynch,Barclays,Goldman_Sachs add
